...
- **Wave 9 (2026-09-17): SF-Bok + World of Board Games** på ägarbeslut — SF-Boks Pokémon TCG är BUTIKSVARA (IN_STOCK = finns i fysisk butik, reservera), WOBG:s kategori var TOM (allt "Utgått"); detaljer i `scraping-restock.md`. **56 butiker, 44 bevakade.**
