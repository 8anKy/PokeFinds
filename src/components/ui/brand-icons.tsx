/**
 * Varumärkesglyfer (Apple, Discord, TikTok, Instagram) — egen fil skild från
 * icons.tsx med flit: stroke-setet är VÅRT formspråk, det här är andras
 * logotyper och ritas som varumärkena själva ritar dem (fyllda, inte stroke).
 * Instagram är undantaget — deras glyf ÄR geometrisk (rundad kvadrat + cirkel
 * + punkt) och tecknas därför i vårt stroke-manér utan att bli fel.
 */
...
/** Googles "G" — fyrfärgad enligt deras riktlinjer för inloggningsknappar. */
